...
using Identity___Legacy_DB.Models;

namespace Identity___Legacy_DB.Providers
{
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        (OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            using (var obj = new LogiClaimBranchEntities())
            {
                ...
                var passwordEncrypted = new SimpleAES().EncryptToString(context.Password);
                var entry = obj.Users
                    .FirstOrDefault(x => x.Username == context.UserName && x.Password == passwordEncrypted);
